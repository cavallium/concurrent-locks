 ...
 */
package it.cavallium.concurrentlocks;
...
public class ReentrantReadWriteUpdateLockTest {
    ...
    public void testUpdateLockIsExclusive() throws Exception {
        ...
        assertTrue(executor1.submit(new TryLockTask(reentrantReadWriteUpdateLock.updateLock(), false)).get());

        // Try to acquire update lock in thread 2, should fail...
        assertFalse(executor2.submit(new TryLockTask(reentrantReadWriteUpdateLock.updateLock(), false)).get());
        ...
        assertTrue(executor2.submit(new TryLockTask(reentrantReadWriteUpdateLock.updateLock(), false)).get());
    ...
    public void testUpdateLockAllowsOtherReaders() throws Exception {
        ...
        assertTrue(executor2.submit(new TryLockTask(reentrantReadWriteUpdateLock.readLock(), false)).get());
    ...
    public void testUpdateLockBlocksOtherWriters() throws Exception {
        ...
        assertFalse(executor2.submit(new TryLockTask(reentrantReadWriteUpdateLock.writeLock(), false)).get());

        // Release the update lock in thread 1...
        assertTrue(executor1.submit(new UnlockTask(reentrantReadWriteUpdateLock.updateLock())).get());

        // Try to acquire write lock in thread 2 again, should succeed...
        assertTrue(executor2.submit(new TryLockTask(reentrantReadWriteUpdateLock.writeLock(), false)).get());
    ...
    public void testWriteLockBlocksOtherReaders() throws Exception {
        ...
        assertTrue(executor1.submit(new TryLockTask(reentrantReadWriteUpdateLock.writeLock(), false)).get());

        // Try to acquire read lock in thread 2, should fail...
        assertFalse(executor2.submit(new TryLockTask(reentrantReadWriteUpdateLock.readLock(), false)).get());
    ...
    public void testPreventedFromAcquiringReadLockIfHoldingUpdateLock() throws Exception {
        ...
        try {
            ...
            executor1.submit(new TryLockTask(reentrantReadWriteUpdateLock.readLock(), true)).get();
        ...
        assertTrue(executor1.submit(new TryLockTask(reentrantReadWriteUpdateLock.readLock(), false)).get());
    ...
    public void testPreventedFromAcquiringUpdateLockIfHoldingReadLock() throws Exception {
        ...
        try {
            ...
            executor1.submit(new TryLockTask(reentrantReadWriteUpdateLock.updateLock(), true)).get();
    ...
    public void testPreventedFromAcquiringWriteLockIfHoldingReadLock() throws Exception {
        ...
        try {
            ...
            executor1.submit(new TryLockTask(reentrantReadWriteUpdateLock.writeLock(), true)).get();
    ...
    static class TryLockTask implements Callable<Boolean> {
        ...
        public TryLockTask(Lock lock, boolean doFail) {
            this.lock = lock;
            this.doFail = doFail;
        }
        @Override
